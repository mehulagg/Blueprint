...
class MainActivity : BottomNavigationBlueprintActivity() {
    ...
    override fun defaultMaterialYouTheme(): Int = R.style.MyApp_Default_MaterialYou_Expressive
    override fun amoledMaterialYouTheme(): Int = R.style.MyApp_Default_Amoled_MaterialYou_Expressive
}
